...
export default function TechCatalogPage() {
  ...
  const techCategories = useMemo(() => {
    return dbCategories.filter(cat => cat.catalog === 'tecnologia');
  }, [dbCategories]);

  const activeCatalogSlugs = useMemo(() => {
    return techCategories.map(cat => cat.slug);
  }, [techCategories]);
  ...
  // Only display Technology and Electronics categories in sidebar
  ...
  return (
    <>
      <Helmet>
        <title>Catálogo de Tecnología y Accesorios | Padilla Store San Miguel</title>
        <meta name="description" content="Explora el catálogo de Tecnología en Padilla Store: fundas premium para celular, cargadores rápidos, audífonos y electrónicos con envío en 24h en San Miguel." />
        <meta property="og:title" content={`Catálogo de Tecnología | ${SITE_NAME}`} />
        <meta property="og:description" content="Accesorios premium para celular, cargadores rápidos y electrónicos con entrega a domicilio en 24h." />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content={SITE_NAME} />
        <meta property="og:url" content={`${BASE_URL}/catalog-tecnologia`} />
        <link rel="canonical" href={`${BASE_URL}/catalog-tecnologia`} />
      </Helmet>
