...
const sprintsContent = `================================================================================
  Padilla's Store — PLAN DE DESARROLLO POR SPRINTS
  Proyecto interno: Padilla's Store
...
TAREAS
─────────────────────────────────────────────────────────────────────────────
  2h  supabaseClient.js: singleton con storageKey 'Padilla's Store-auth' (evita conflictos
...
─────────────────────────────────────────────────────────────────────────────
  ...
  3h  useTheme.js: dark mode con persistencia 'Padilla's Store_theme', migración de key
  ...
  3h  AuthContext.jsx: caché en sessionStorage (Padilla's Store_user, Padilla's Store_profile,
      Padilla's Store_auth_cache_time) con TTL 1 hora
...
─────────────────────────────────────────────────────────────────────────────
  4h  CartContext.jsx: addToCart, removeFromCart, updateQuantity, clearCart
      con escritura inmediata en localStorage (Padilla's Store_cart) como fuente primaria
  ...
  2h  CartContext.jsx: expiración automática a los 7 días de inactividad
      (Padilla's Store_cart_timestamp) con notificación toast
      → src/context/CartContext.jsx
...
─────────────────────────────────────────────────────────────────────────────
  3h  ErrorBoundary.jsx: captura errores de render, UI de recuperación con 2 opciones.
      ...
      NUNCA Padilla's Store_cart ni Padilla's Store_favorites
      → src/components/ErrorBoundary.jsx

  2h  Logo.jsx: icono Material Symbols + texto 'Padilla's Store', versiones sm/md/lg
  ...
  3h  admin/AdminLayout.jsx desktop: sidebar colapsable + header con avatar
      ...
      → src/Padilla's Store/admin/AdminLayout.jsx
...
─────────────────────────────────────────────────────────────────────────────
  ...
  3h  HomePage.jsx: sección Hero — imagen desde settings.hero_image_url,
      ...
      → src/Padilla's Store/HomePage.jsx
  ...
  5h  CatalogPage.jsx: sincronización bidireccional con URL searchParams
      ...
      → src/Padilla's Store/CatalogPage.jsx
...
─────────────────────────────────────────────────────────────────────────────
  3h  ProductDetailPage.jsx: galería — imagen principal + thumbnails clickeables
      ...
      → src/Padilla's Store/ProductDetailPage.jsx
  ...
  3h  ContactPage.jsx: campos nombre, email, asunto (select), mensaje.
      ...
      → src/Padilla's Store/ContactPage.jsx
  ...
  4h  SEO meta tags: react-helmet-async en todas las páginas públicas —
      ...
      → Todas las páginas en src/Padilla's Store/
...
─────────────────────────────────────────────────────────────────────────────
  4h  DashboardPage.jsx: RPC get_dashboard_data → StatCards para cada métrica
      ...
      → src/Padilla's Store/admin/DashboardPage.jsx
  ...
  4h  ProductsPage.jsx: listado con búsqueda debounce 500ms, filtro por categoría,
      ...
      → src/Padilla's Store/admin/ProductsPage.jsx
...
const funcContent = `# Padilla's Store — Descripción funcional del código
