      ...
      >
        ...
        <div className="relative border-b border-gray-100 dark:border-white/5 flex items-center p-[var(--space-md)] sm:p-[var(--space-lg)] pb-[var(--space-md)]">
          ...
          <input 
            ...
            placeholder="Busca cases, cargadores, audífonos..." 
                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-[var(--space-md)]">
                   {results.slice(0, 6).map(item => (
                     <button 
                       ...
                       className="w-full text-left flex items-center gap-[var(--space-md)] p-[var(--space-sm)] bg-white dark:bg-white/5 rounded-2xl cursor-pointer hover:shadow-md border border-transparent hover:border-slate-300 dark:hover:border-primary/40 transition-all group"
                     >
