...
const ProductCardComponent = function ProductCard({ product }) {
  ...
  return (
    <article
      ...
      className="group relative block overflow-hidden bg-white dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-white/5 shadow-sm hover:shadow-md transition-all duration-300 max-w-[240px] w-full mx-auto"
    >
