...
export default function SocialIcons({ variant = 'solid', className = '' }) {
  ...
  return (
    <div className={`flex items-center justify-between sm:justify-start w-full ${className}`}>
      {/* Facebook */}
      <a href={settings?.social_facebook || "https://www.facebook.com/inovasv"} target="_blank" rel="noopener noreferrer" className={iconClasses} aria-label="Facebook">
      ...
      {/* Instagram */}
      <a href={settings?.social_instagram || "https://www.instagram.com/inovasv"} target="_blank" rel="noopener noreferrer" className={iconClasses} aria-label="Instagram">
      ...
      {/* TikTok (only glass) */}
      {variant === 'glass' && (
        <a href={settings?.social_tiktok || "https://www.tiktok.com/@inovasv"} target="_blank" rel="noopener noreferrer" className={iconClasses} aria-label="TikTok">
