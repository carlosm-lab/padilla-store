...
export default function SocialIcons({ variant = 'solid', className = '' }) {
  ...
  return (
    <div className={`flex items-center justify-between sm:justify-start w-full ${className}`}>
      {/* Facebook */}
      <a href={sanitizeUrl(settings?.social_facebook) || "https://www.facebook.com/padillastore"} target="_blank" rel="noopener noreferrer" className={iconClasses} aria-label="Facebook">
      ...
      {/* Instagram */}
      <a href={sanitizeUrl(settings?.social_instagram) || "https://www.instagram.com/padillastore"} target="_blank" rel="noopener noreferrer" className={iconClasses} aria-label="Instagram">
      ...
      {/* TikTok (only glass) */}
      {variant === 'glass' && (
        <a href={sanitizeUrl(settings?.social_tiktok) || "https://www.tiktok.com/@padillastore"} target="_blank" rel="noopener noreferrer" className={iconClasses} aria-label="TikTok">
