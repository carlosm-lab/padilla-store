  ...
  const fetchSettings = async () => {
    try {
      const { data, error } = await supabase
        .from('store_settings')
        .select('id, hero_title, hero_subtitle, hero_description, hero_image_url, story_image_url, contact_phone, contact_email, social_facebook, social_instagram, social_tiktok, created_at, updated_at')
        .single();
